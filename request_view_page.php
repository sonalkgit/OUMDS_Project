...
<div class="container">
    ...
    <ul class="main-nav js--main-nav">
        ...
        <li><a href="request_page.html">Request</a></li>
        ...
        <div class="row">
            <div class="col-sm-12 container jumbotron headerprt">
                <div
                    ...
                    <h1 class="display-4" style="padding-left: 50vh;padding-bottom: 2vh;">
                       View Request Medicine
                    </h1>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary"><a style="color:white" href="request_donate.php?dataid=<?php echo $data['request-id']?>" type="submit" name="reqid">donate</a></button>
                                </td>
                            </tr>
                            <?php
                            }
